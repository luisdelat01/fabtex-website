...
const SocialProof: React.FC = () => {
  ...
  const trust1Ref = useScrollAnimation();
  const trust2Ref = useScrollAnimation();
    ...
    <section id="testimonials" className="bg-white py-20 lg:py-28">
      <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="max-w-4xl mx-auto">
          <div 
            ref={testimonialRef.ref as React.RefObject<HTMLDivElement>}
            className={`bg-gradient-to-br from-brand-purple to-brand-purple/90 rounded-3xl p-8 sm:p-8 md:p-12 lg:p-16 shadow-2xl relative overflow-hidden fade-in-up ${testimonialRef.isVisible ? 'visible' : ''}`}
          >
            ...
            <div className="relative mb-8">
              <svg className="w-16 h-16 text-golden-amber/40" fill="currentColor" viewBox="0 0 32 32">
            ...
            <blockquote className="relative">
              <p className="text-xl sm:text-xl md:text-2xl lg:text-3xl text-white leading-relaxed font-medium mb-8">
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div 
            ref={trust1Ref.ref as React.RefObject<HTMLDivElement>}
            className={`text-center fade-in-up stagger-1 ${trust1Ref.isVisible ? 'visible' : ''}`}
          >
          ...
          <div 
            ref={trust2Ref.ref as React.RefObject<HTMLDivElement>}
            className={`text-center fade-in-up stagger-2 ${trust2Ref.isVisible ? 'visible' : ''}`}
          >
            <div className="inline-flex items-center justify-center w-16 h-16 bg-vibrant-teal/10 rounded-xl mb-4">
              <svg className="w-8 h-8 text-vibrant-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div 
            ref={trust3Ref.ref as React.RefObject<HTMLDivElement>}
            className={`text-center fade-in-up stagger-3 ${trust3Ref.isVisible ? 'visible' : ''}`}
          >
            <div className="inline-flex items-center justify-center w-16 h-16 bg-vibrant-teal/10 rounded-xl mb-4">
              <svg className="w-8 h-8 text-vibrant-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
