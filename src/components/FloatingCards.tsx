      ...
      >
        <div className="bg-white rounded-xl p-5 shadow-2xl">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#E8A765] to-[#d89555] flex items-center justify-center">
          ...
          <p className="text-[#1A1A2E] font-medium mb-2">Smart Questions to Ask:</p>
          <ul className="space-y-1.5 text-sm text-[#1A1A2E]/80">
      ...
      >
        <div className="bg-white rounded-xl p-5 shadow-2xl">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-semibold text-[#1A1A2E]">Active Deals</h3>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <span className="ml-auto text-xs font-semibold text-[#3DBFB3]">$245K</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-[#E8A765]" />
              <span className="text-sm text-[#1A1A2E] font-medium">Zara Denim Line</span>
              <span className="ml-auto text-xs font-semibold text-[#E8A765]">$180K</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-[#64748B]" />
              <span className="text-sm text-[#1A1A2E] font-medium">H&M Basics</span>
              <span className="ml-auto text-xs font-semibold text-[#64748B]">$92K</span>
            </div>
          </div>
          <div className="mt-4 pt-3 border-t border-gray-200">
            <div className="flex items-center justify-between text-xs">
              <span className="text-[#64748B]">Pipeline Total</span>
              <span className="font-semibold text-[#1A1A2E]">$517K</span>
            </div>
          </div>
        </div>
      </FloatingCard>
        ...
        <div className="bg-white rounded-xl p-5 shadow-2xl">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="w-3 h-3 rounded-full bg-[#3DBFB3] mt-1" />
            ...
            <div className="flex items-start gap-3">
              <div className="w-3 h-3 rounded-full bg-[#E8A765] mt-1" />
              <div className="flex-1">
